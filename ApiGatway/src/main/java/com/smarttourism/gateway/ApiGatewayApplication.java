...
public class ApiGatewayApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  • SOAP WSDL: http://localhost:8090/ws/culturalArchive.wsdl");
        System.out.println("  • SOAP Endpoint: http://localhost:8090/ws");
        System.out.println("  • GraphQL Endpoint: http://localhost:8080/graphql");
        System.out.println("  • Apollo Sandbox GraphQL: http://localhost:8080/graphql-sandbox");
