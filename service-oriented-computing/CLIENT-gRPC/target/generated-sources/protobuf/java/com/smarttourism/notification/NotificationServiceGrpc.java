...
public final class NotificationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.smarttourism.notification.AlertRequest,
      com.smarttourism.notification.AlertResponse> getChatAlertsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ChatAlerts",
      requestType = com.smarttourism.notification.AlertRequest.class,
      responseType = com.smarttourism.notification.AlertResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.smarttourism.notification.AlertRequest,
      com.smarttourism.notification.AlertResponse> getChatAlertsMethod() {
    io.grpc.MethodDescriptor<com.smarttourism.notification.AlertRequest, com.smarttourism.notification.AlertResponse> getChatAlertsMethod;
    if ((getChatAlertsMethod = NotificationServiceGrpc.getChatAlertsMethod) == null) {
      synchronized (NotificationServiceGrpc.class) {
        if ((getChatAlertsMethod = NotificationServiceGrpc.getChatAlertsMethod) == null) {
          NotificationServiceGrpc.getChatAlertsMethod = getChatAlertsMethod =
              io.grpc.MethodDescriptor.<com.smarttourism.notification.AlertRequest, com.smarttourism.notification.AlertResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ChatAlerts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smarttourism.notification.AlertRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.smarttourism.notification.AlertResponse.getDefaultInstance()))
              .setSchemaDescriptor(new NotificationServiceMethodDescriptorSupplier("ChatAlerts"))
              .build();
        }
      }
    }
    return getChatAlertsMethod;
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.smarttourism.notification.AlertRequest> chatAlerts(
        io.grpc.stub.StreamObserver<com.smarttourism.notification.AlertResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getChatAlertsMethod(), responseObserver);
    }
  }
  ...
  public static final class NotificationServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.smarttourism.notification.AlertRequest> chatAlerts(
        io.grpc.stub.StreamObserver<com.smarttourism.notification.AlertResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncBidiStreamingCall(
          getChannel().newCall(getChatAlertsMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_CHAT_ALERTS = 3;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_CHAT_ALERTS:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.chatAlerts(
              (io.grpc.stub.StreamObserver<com.smarttourism.notification.AlertResponse>) responseObserver);
        default:
          throw new AssertionError();
      }
